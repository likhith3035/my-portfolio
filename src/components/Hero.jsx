        ...
        <div className="flex flex-col md:hidden items-center text-center gap-5">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
            ...
            <div className="animate-float relative inline-block">
              ...
              <div className={`absolute -bottom-1 -right-1 flex items-center gap-1.5 px-2.5 py-1.5 rounded-full border shadow-lg text-[10px] font-black uppercase tracking-wide ${badgeBg} ${badgeText} ${isDark ? 'shadow-[0_0_16px_rgba(16,185,129,0.3)] border-emerald-500/40' : 'shadow-[0_4px_16px_rgba(16,185,129,0.15)] border-emerald-500/25'}`}
                style={{ backdropFilter: 'blur(8px)' }}>
                <span className="relative flex h-2 w-2 flex-shrink-0">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500 shadow-[0_0_8px_#10b981]"></span>
                </span>
                <span className="text-emerald-500 font-extrabold">Available</span>
              </div>
            </div>
          </motion.div>
            ...
            <TiltCard>
              <div className="animate-float relative">
                ...
                <motion.div initial={{ opacity: 0, scale: 0.7 }} animate={{ opacity: 1, scale: 1 }}
                  ...
                  className={`absolute -top-4 -right-4 flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl border shadow-lg z-20 backdrop-blur-md ${badgeBg} ${isDark ? 'shadow-[0_0_20px_rgba(16,185,129,0.3)] border-emerald-500/40' : 'shadow-[0_8px_24px_rgba(16,185,129,0.15)] border-emerald-500/25'}`}>
                  <span className="relative flex h-2.5 w-2.5 flex-shrink-0">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500 shadow-[0_0_10px_#10b981]"></span>
                  </span>
                  <div>
                    <div className={`text-[11px] font-black uppercase tracking-wider text-emerald-600 dark:text-emerald-400`}>Available</div>
